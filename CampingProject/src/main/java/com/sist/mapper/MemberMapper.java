...
public interface MemberMapper {
	...
	// 회원가입
	@Insert("INSERT INTO member(id,pwd,name,sex,birthday,email,post,addr1,addr2,phone,content,enable) "
	...
	// 세션 저장 정보
	@Select("SELECT id,name,nickname,sex FROM member WHERE id=#{id}")
