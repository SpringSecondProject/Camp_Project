								...
								<div class="col-lg-4 col-md-6 col-sm-6" v-for="vo in list">
									<div class="product-m">
										<div class="product-m__thumb">
											...
											<a class="aspect"
											   :href="'../item/detail.do?ino='+vo.ino">
												<img class="aspect_img"
												     :src="'https://www.ocamall.com'+vo.poster"
												     alt=""/>
											</a>
										...
										<div class="product-m__content">
											<div class="product-m__category">
												...
												<a href="shop-side-version-2.html">{{vo.type}}</a>
											</div>
											<div class="product-m__name">

												<a :href="'../item/detail.do?ino='+vo.ino">{{vo.name}}</a>
											</div>
