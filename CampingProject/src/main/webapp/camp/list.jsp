				...
				<div class="col-lg-9 col-md-12">
					<div class="shop-p">
						...
						<div class="shop-p__collection">
							...
							<div v-if="list.length === 0" class="u-s-m-b-30"
									...
									<div class="product-m">
										...
										<div class="product-m__content">
											...
											<div class="product-m__name">
												...
												<a :href="'/camp/detail.do?cno=' + vo.cno">{{
													vo.title }}</a>
											</div>
											...
											<div class="product-m__name"
												...
												<a style="color: #4285F4 !important;"
												   href="shop-side-version-2.html">가격 :
													{{vo.price.toLocaleString()+ '원'}} </a>
											</div>
											...
											<div class="product-m__category">
												...
												<a href="shop-side-version-2.html">종류 :
													{{vo.induty}} </a>
											</div>

											<div class="product-m__category">

												<a href="shop-side-version-2.html">애견 동반 :
													{{vo.animalCmgCl}} </a>
											</div>


											<div class="product-m__category">
												<a href="shop-side-version-2.html">환경 정보 :
													{{vo.lctCl || '없음' }} </a>
											</div>
											...
											<div class="product-m__hover">
												...
												<div class="product-m__wishlist">
													...
													<a class="far fa-heart" data-tooltip="tooltip"
											...
											<div class="shop-w__form-p-wrap">
												<div>
													...
													<input class="input-text input-text--primary-style"
													       ...
													       v-model="minPrice" placeholder="최소금액">
												</div>
												<div>
							...
							<div class="u-s-m-b-30">
								<div class="shop-w">
									<div class="shop-w__intro-wrap">
										...
										<span class="fas fa-minus shop-w__toggle"
										      data-target="#s-pet" data-toggle="collapse"></span>
									</div>
									<div class="shop-w__wrap collapse show" id="s-pet">
										<ul class="shop-w__list gl-scroll">
											...
											<li>
												<div class="radio-box">
													<input type="radio" id="dog-small" value=""
													       v-model="selectedPet"
													       @change="pageChange(1)">
											...
											<li>
												<div class="radio-box">
													<input type="radio" id="dog-small"
													       value="가능(소형견)" v-model="selectedPet"
													       @change="pageChange(1)">
													<div class="radio-box__state radio-box__state--primary">
														<label class="radio-box__label">소형견
															가능</label>
													</div>
												</div>
											</li>
											...
											<li>
												<div class="radio-box">
													<input type="radio" id="dog-all" value="가능"
													       v-model="selectedPet"
													       @change="pageChange(1)">
													<div class="radio-box__state radio-box__state--primary">
														<label class="radio-box__label">모든견종
															가능</label>
													</div>
												</div>
											</li>
											...
											<li>
												<div class="radio-box">
													<input type="radio" id="no-pet" value="불가능"
													       v-model="selectedPet"
													       @change="pageChange(1)">
													<div class="radio-box__state radio-box__state--primary">
														<label class="radio-box__label">애견동반
															불가</label>
													</div>
												</div>
											</li>
							...
							<div class="u-s-m-b-30">
								<div class="shop-w">
									<div class="shop-w__intro-wrap">
										...
										<span class="fas fa-minus shop-w__toggle"
										      data-target="#s-type" data-toggle="collapse"></span>
									</div>
									<div class="shop-w__wrap collapse show" id="s-type">
										<ul class="shop-w__list gl-scroll">
											...
											<li v-for="item in typeCounts" :key="item.induty">
												<div class="check-box">
													<input type="checkbox" :value="item.induty"
							...
							<div class="u-s-m-b-30">
								<div class="shop-w">
									<div class="shop-w__intro-wrap">
										...
										<span class="fas fa-minus shop-w__toggle"
										      data-target="#s-envir" data-toggle="collapse"></span>
									</div>
									<div class="shop-w__wrap collapse show" id="s-envir">
										<ul class="shop-w__list gl-scroll">
											...
											<li v-for="Llist in lctclCounts" :key="Llist.lctcl">
												<div class="check-box">
													<input type="checkbox" :value="Llist.lctcl"
													       v-model="lctcl" @change="pageChange(1)">
													<div class="check-box__state check-box__state--primary">
														<label class="check-box__label">{{
															Llist.lctcl }}</label>
													</div>
...
<script>
  let campListApp = Vue.createApp({
    ...
    methods: {
      ...
      getLctclCounts() {
        axios.get("/web/camp/lctcl_count_vue.do")
        .then(res => {
          this.lctclCounts = res.data
        })
      },
      getTypeCounts() {
        axios.get("/web/camp/type_count_vue.do")
        .then(res => {
          this.typeCounts = res.data // 캠핑장 종류별 필터 갯수
        })
      },
      getLocationCounts() { // 지역별 필터 갯수
        axios.get("/web/camp/location_count_vue.do")
        .then(res => {
      ...
      dataRecv() {
        ...
        axios.get('/web/camp/list_vue.do', {
          params: {
            page: this.curpage,
