							...
							<li class="has-dropdown">
								...
								<ul style="width:170px" id="sample">
									...
									<li class="has-dropdown has-dropdown--ul-left-100">
										...
										<a href="../sample/dashboard.html">Dashboard<i
										...
										<ul style="width:200px">
											<li class="has-dropdown has-dropdown--ul-left-100">
												...
												<a href="../sample/dashboard.html">Manage My Account<i
														class="fas fa-angle-down i-state-right u-s-m-l-6"></i></a>
												...
												<ul style="width:180px">
													<li>
														...
														<a href="../sample/dash-edit-profile.html">Edit
															Profile</a></li>
													<li>

														<a href="../sample/dash-address-book.html">Edit
															Address Book</a></li>
													<li>

														<a href="../sample/dash-manage-order.html">Manage
															Order</a></li>
												</ul>
												<!--====== End - Dropdown ======-->
											</li>
											<li>
												...
												<a href=../sample/"dash-my-profile.html">My
													Profile</a></li>
											<li class="has-dropdown has-dropdown--ul-left-100">

												<a href="../sample/dash-address-book.html">Address
													Book<i class="fas fa-angle-down i-state-right u-s-m-l-6"></i></a>
												...
												<ul style="width:180px">
													<li>
														...
														<a href="../sample/dash-address-make-default.html">Address
															Make Default</a></li>
													<li>

														<a href="../sample/dash-address-add.html">Add
															New Address</a></li>
													<li>

														<a href="../sample/dash-address-edit.html">Edit
															Address Book</a></li>
												</ul>
												<!--====== End - Dropdown ======-->
											</li>
											<li>
												...
												<a href="../sample/dash-track-order.html">Track
													Order</a></li>
											<li>

												<a href="../sample/dash-my-order.html">My Orders</a>
											</li>
											<li>

												<a href="../sample/dash-payment-option.html">My
													Payment Options</a></li>
											<li>

												<a href="../sample/dash-cancellation.html">My
									...
									<li class="has-dropdown has-dropdown--ul-left-100">
										...
										<ul style="width:200px">
											<li>
												...
												<a href="../sample/empty-search.html">Empty
													Search</a></li>
											<li>

												<a href="../sample/empty-cart.html">Empty Cart</a>
											</li>
											<li>

												<a href="../sample/empty-wishlist.html">Empty
													Wishlist</a></li>
										</ul>
										<!--====== End - Dropdown ======-->
									</li>
									<li class="has-dropdown has-dropdown--ul-left-100">
										...
										<ul style="width:200px">
											<li>
												...
												<a href="../sample/product-detail.html">Product
													Details</a></li>
											<li>

												<a href="../sample/product-detail-variable.html">Product
													Details Variable</a></li>
											<li>

												<a href="../sample/product-detail-affiliate.html">Product
									...
									<li class="has-dropdown has-dropdown--ul-left-100">
										...
										<ul style="width:200px">
											<li>
												...
												<a href="../sample/shop-grid-left.html">Shop Grid
													Left Sidebar</a></li>
											<li>

												<a href="../sample/shop-grid-right.html">Shop Grid
													Right Sidebar</a></li>
											<li>

												<a href="../sample/shop-grid-full.html">Shop Grid
													Full Width</a></li>
											<li>

												<a href="../sample/shop-side-version-2.html">Shop
													Side Version 2</a></li>
										</ul>
										<!--====== End - Dropdown ======-->
									</li>
									<li class="has-dropdown has-dropdown--ul-left-100">
										...
										<ul style="width:200px">
											<li>
												...
												<a href="../sample/shop-list-left.html">Shop List
													Left Sidebar</a></li>
											<li>

												<a href="../sample/shop-list-right.html">Shop List
													Right Sidebar</a></li>
											<li>

												<a href="../sample/shop-list-full.html">Shop List
													Full Width</a></li>
										</ul>
										<!--====== End - Dropdown ======-->
									</li>
									...
									<li class="has-dropdown has-dropdown--ul-left-100">
										...
										<ul style="width:200px">
											<li>
												<a href="../sample/blog-left-sidebar.html">Blog Left
													Sidebar</a></li>
											<li>

												<a href="../sample/blog-right-sidebar.html">Blog
													Right Sidebar</a></li>
											<li>

												<a href="../sample/blog-sidebar-none.html">Blog
													Sidebar None</a></li>
											<li>

												<a href="../sample/blog-masonry.html">Blog
													Masonry</a></li>
											<li>

												<a href="../sample/blog-detail.html">Blog
													Details</a></li>
										</ul>
										<!--====== End - Dropdown ======-->
									</li>
									<li>
										<a href="../sample/shop-side-version-2.html">VALUE OF THE
											DAY</a></li>
									<li>
										<a href="../sample/shop-side-version-2.html">GIFT CARDS</a>
									</li>
								</ul>
								<!--====== End - Dropdown ======-->
							</li>
