						            ...
						            <div class="row">
						                <div class="col-12">
						                    <div class="slider-content slider-content--animation">
						                        ...
						                        <a class="shop-now-link btn--e-brand" href="../camp/list.do" style="font-size: 16px;" >장소 둘러보기 →</a>
						                    </div>
						                </div>
						            </div>
						        </div>
						   ...
						   <div class="hero-slide hero-slide--5">
						        <div class="primary-style-2-container">
						            <div class="row">
						                <div class="col-12">
						                    <div class="slider-content slider-content--animation">
						                        <span class="content-span-1 u-c-white">캠핑카 타고 지금 출발!</span><br>
						                        ...
						                        <span class="content-span-4 u-c-white">
						                            시작가 <span class="u-c-brand">₩140,000</span>
						                        </span><br><br>
						                        <a class="shop-now-link btn--e-brand" href="../campcar/list.do" style="font-size: 16px;">지금 예약하기 →</a>
						                    </div>
						                </div>
						            </div>
						        </div>
						    ...
						    <div class="hero-slide hero-slide--6">
						        <div class="primary-style-2-container">
						            <div class="row">
						                <div class="col-12">
						                    <div class="slider-content slider-content--animation">
						                        <span class="content-span-1 u-c-black">매진 임박!</span><br>
						                        <span class="content-span-2 u-c-black">캠핑! 뭐가 필요하지?</span><br>
						                        <span class="content-span-3 u-c-black">"꼭 필요한 캠핑용품을 한눈에!"</span><br>
						                        <span class="content-span-4 u-c-black">
						                            최대 할인 <span class="u-c-brand">80%</span>
						                        </span><br><br>
						                        <a class="shop-now-link btn--e-brand" href="../item/list.do" style="font-size: 16px;">지금 구매하기 →</a>
						                    </div>
						                </div>
						            </div>
						        </div>
